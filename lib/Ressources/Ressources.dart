...
const String str_confirmAccMsg =
    'أدخل رمز التحقق المرسل إلى حسابك الإلكتروني لتأكيد حسابك';
...
const String err_codeConfirm =
    'رجاء انسخ كود التأكيد المرسل إلى بريدك الإلكتروني';
const String err_mailConfirm =
    'رجاء انسخ كود التأكيد المرسل إلى بريدك الإلكتروني';
...
List<TextInputFormatter> formatTxtAr = [
  WhitelistingTextInputFormatter(RegExp("[\ ,ا-يؤ,ئ,أ,إA-Za-z]")),
];
List<TextInputFormatter> formatTxt = [
  WhitelistingTextInputFormatter(RegExp("[.,_,-1-9A-Za-z]")),
];
