...
class ChallengeApi {
  final String url =
      "https://mymission-api.herokuapp.com/api/getTrandingInPoints";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<Challenge> challengeList =
            challenges.challenges.map((e) => Challenge.fromJson(e)).toList();
  ...
  Future<bool> updateUser(int id, String role, is_banned) async {
    ...
    try {
      http.Response response = await http.post(upUrl, headers: {
        "Accept": "application/json",
        "Authorization":
