...
class TimerNotif with WidgetsBindingObserver {
  ...
  TimerNotif.timerEnd() {
    ...
    flutterLocalNotificationsPlugin.initialize(initializationSettings,
        onSelectNotification: onSelectNotificationTimer);
    WidgetsBinding.instance.addObserver(this);

    _showNotificationWithSound('capsuleend',
        txtMsg: 'أحسنت لقد أنهيت كبسولاتك');
  }
  ...
  Future _showNotificationWithSound(sound, {txtMsg = ''}) async {
    ...
    var iOSPlatformChannelSpecifics =
        new IOSNotificationDetails(sound: "notif");
    ...
    await flutterLocalNotificationsPlugin.show(
      0,
      txtMsg == '' ? 'التوثيق اليومي' : '! أحسنت',
      txtMsg == '' ? 'وثق يومك' : txtMsg,
  ...
  Future onSelectNotificationTimer(String payload) async {
    ...
    try {
      await Navigator.push(
        ...
        new MaterialPageRoute(builder: (context) => TimerScreen()),
      );
    } catch (e) {
      print(e.toString());
    }
