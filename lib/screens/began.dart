          ...
          children: [
            ...
            Container(
                ...
                margin: EdgeInsets.only(
                    top: size.height * .56, right: 0.06 * size.width),
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        '   مرحبا بك في تطبيق تحدي الستين الخاص بلعبة الحياة.هذا التطبيق \n   سيساعدك  على توثيق التحدي الخاص بك \n   تم تطوير هذا التطبيق من قبل أبطال اللعبة  Developers.',
                    ...
                    new Container(
                        margin:
                            EdgeInsets.only(right: size.width * .65, top: 0),
