    ...
    Future.delayed(
      ...
      if (_checkNum.text.trim() == '')
        ...
        try {
          ...
          var response = await db.verifyEmail(
              widget.email, _checkNum.text); //lalla@seba_123.com
          print('response register: ${response}');
          if (response)
            Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (BuildContext context) =>
                    LoginRegisterScreen(login: true, first: true)));
          //Navigator.of(context).pushNamed('/homeUser');
          else {
            if (msgError.toLowerCase() == err_codeMissed.toLowerCase() ||
                msgError.toString().toLowerCase().contains('email'))
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (BuildContext context) => LoginRegisterScreen()));
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      radius: logosize,
                      backgroundImage:
                          AssetImage('assets/images/logoblack.png'),
                    ),
                    SizedBox(
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                widget.confirm ? str_codeConfirm : str_email,
                            hintStyle: TextStyle(
                                fontFamily: fntAljazeera,
                                fontSize: 15.0,
                    ...
                    Container(
                      ...
                      child: MaterialButton(
                        child: Text(
                          widget.confirm ? str_resendConfirm : str_haveConfirm,
                          style: new TextStyle(
