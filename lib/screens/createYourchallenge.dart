...
class yourChallengestata extends State<yourChallenge> {
  ...
  Image icon1 = Image.asset(
    "assets/images/account.png",
    scale: 4,
  );
  Image icon2 = Image.asset(
    "assets/images/goal.png",
    scale: 4,
  );
  Image icon3 = Image.asset(
    "assets/images/inste.png",
    scale: 4,
  );
                ...
                Container(
                  child: SingleChildScrollView(
                    child: Stack(children: [
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: AssetImage(loadPrs
                                    ? 'assets/images/startc2.png'
                                    : 'assets/images/startc1.png'),
                                fit: BoxFit.fill,
                              ),
                            ),
                            ...
                            child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (heroname.text.isNotEmpty &&
                                      herogoal.text.isNotEmpty &&
                                      heroinstegram.text.isNotEmpty) {
                                    bool response = await ch.createChallenge(
                                        heroname.text,
                                        heroinstegram.text,
                                        herogoal.text);
                                    if (response) {
                      ...
                      (respnmsg).trim() == ''
                          ? Text('')
                          : alertMsg(context, respnmsg, marge: -75),
                    ]),
                  ),
                )
              ],
