...
class dailyTaskstate extends State<dailyTask> {
  ...
  /////////////
  Image im2 = Image.asset(
    "assets/images/exercise-1.png",
    scale: 4,
  );
  Image im3 = Image.asset(
    "assets/images/pencil.png",
    scale: 4,
  );
  Image im4 = Image.asset(
    "assets/images/exercise.png",
    scale: 4,
  );
  Image im5 = Image.asset(
    "assets/images/aim.png",
    scale: 4,
  );
  Image im6 = Image.asset(
  ...
  Widget build(BuildContext context) {
    ...
    if (urlavatar == null || urlavatar.trim() == '') urlavatar = '';
    var size = MediaQuery.of(context).size;
    double h = size.height * .10;

    var fntelm = size.width * .036;
    if (fntelm > 15) fntelm = 15;

    var fntTitle = 19.0; //size.height*.035;
    if (fntTitle > 30) fntTitle = 30;

    return Scaffold(
        appBar: PreferredSize(
          preferredSize:
              Size.fromHeight(size.height * .15), // here the desired height
          child: PreferredSize(
              ...
              actions:
                ...
                Container(
                  margin: EdgeInsets.only(
                      right: size.width * .03, top: size.height * .03),
                  child: CircleAvatar(
          ...
          child: Stack(children: [
            Container(
                ...
                child: Center(
                          ...
                          child: FlutterSwitch(
                            ...
                            onToggle: (val) {
                              setState(() {
                                ...
                                nchallenge.saveTask(status, status2, status3,
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: size.height * .013),
                  ),
                  Container(
                    width: size.width * .83,
                    height: h,
                  ...
                  Container(
                      ...
                      child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            point = sumpoint(status, status2, status3, status4,
                                status5, status6);
                            if (point == 0) {
            ...
            (resmessage).trim() == ''
                ? Text('')
                : alertMsg(context, resmessage, marge: 142),
          ]),
        ));
  }
}
