                            ...
                            child: Stack(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  child: Center(
                                    child: Text(
                                      'الكبسولة هي وحدة زمنية مدتها 25 دقيقة',
                                      style: TextStyle(
                                        fontSize: 12, fontFamily: fntAljazeera,
                                        //  height: 0.5,
                                      ),
                                ...
                                Container(
                                    ...
                                    child: Stack(
                                      children: <Widget>[
                                        ...
                                        Padding(
                                            padding:
                                                EdgeInsets.only(bottom: 67),
                                            child: Align(
                                                alignment:
                                                    Alignment.bottomCenter,
                                                child: Text('مجموع الكبسولات',
                                                    style: TextStyle(
                                                      fontSize: 12,
                                                      fontFamily: fntAljazeera,
                                                    )))),
                            ...
                            children: <Widget>[
                              Padding(
                                  ...
                                  child: Align(
                                      alignment: Alignment.center,
                                      child: Text(
                                        'لتشغيل كبسولتين أو أكثر بشكل أوتوماتيكي \nاختر العدد المناسب لك من هنا',
                                        style: TextStyle(
                                          fontSize: 10,
                                          fontFamily: fntAljazeera,
                                        ),
                                          ...
                                          Container(
                                            ...
                                            child: FlatButton(
                                              ...
                                              onPressed: () => launchInBrowser(
                                                  "https://www.youtube.com/watch?v=N0FAsZvVOAo&t=1s"),
                                            ),
                                          ),
                                          Text(
                                            'لمزيد من الشرح  ',
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Text(
                    ...
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontFamily: fntAljazeera, fontSize: 20, height: 1.3)),
                Container(
                  width: 70,
                  child: Text('الرصيد\n43',
                      textAlign: TextAlign.center,
