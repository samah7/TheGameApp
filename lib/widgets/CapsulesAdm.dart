...
class listCapsulesAdm extends StatefulWidget{
  listCapsulesAdm( {Key key} ) :super(key:key);
...
class listAdmintstate extends State<listCapsulesAdm> {
  var size;
  bool status=true;
  List k;
  List userDetails=[];
  ...
  void initState() {
    super.initState();
     db.getTrandingcapsules().then((value) {
      setState(() {
        k=value;
        userDetails=value;
             ...
             //margin:EdgeInsets.only(top:10,) ,
               child:ListView.builder(
                   ...
                   itemBuilder: (BuildContext context, int position) {
                     ...
                     onTap: ()async{
                     var s= db.delete(searchResult[position].user_id);
                     if(s==true){
                       setState(() {
                                 ...
                                 child: Center(child:Row(
                                   ...
                                   children: [
                                     ...
                                     Container(
                                       ...
                                       child:  (searchResult[position].user_id==1)?Container() :CircleAvatar(
                                         backgroundColor: Colors.black,
                                         radius:size.width*.0628,
                                         child: CircleAvatar(backgroundColor: Colors.white,
                                             radius:size.width*.0603,
                                             child: Text('${searchResult[position].capsules}',style:TextStyle(
                                               fontSize:(scapsues>20)?20:scapsues,
                                             ),)),),),
                                     ////User's name
                                    ////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
                                     ...
                                     Container(margin: EdgeInsets.only(right: size.width*.05),////circle of numbers
                                       child:Center(child:Column(
                                         ...
                                         children: [
                                           Container(
                                             margin: EdgeInsets.only(top:searchResult[position].user_id==1?25:5),
                                             child:CircleAvatar(
                                                 backgroundColor: Colors.black,
                            ...
                            Container(
                              ...
                              child: Center(child:Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    margin:  EdgeInsets.only(left: 12),
                                    child:  (k[position].user_id==1)?Container() :
                                    CircleAvatar(
                                      backgroundColor: Colors.black,
                                      radius:size.width*.0628,
                                      child: CircleAvatar(backgroundColor: Colors.white,
                                          radius:size.width*.0603,
                                          child: Text('${k[position].capsules}',style:TextStyle(
...
///////////////////////////////////////////////////////////
                                  ...
                                  Container(margin: EdgeInsets.only(right: size.width*.05),////circle of numbers
                                    child:Column(children: [
                                      Container(
                                        margin: EdgeInsets.only(top:k[position].user_id==1?22:12),
                                        child:CircleAvatar(
                                          backgroundColor: Colors.black,
                                          radius: size.width*.031,
                                          child:CircleAvatar(
