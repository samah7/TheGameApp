            ...
            child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'بحث',
                    hintStyle:
                        TextStyle(color: Colors.grey, fontFamily: fntAljazeera),
                    filled: true,
                    fillColor: Colors.white70,
                    enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.all(Radius.circular(25.0)),
                      borderSide:
                          BorderSide(color: Color(0xffF4C852), width: 2),
                    ),
                                                      ...
                                                      Container(
                                                          ...
                                                          child:
                                                            ...
                                                            onTap: () {
                                                              setState(() {
                                                                var url =
                                                                    'https://www.instagram.com/${searchResult[position].hero_instagram}/';
                                                                launchInBrowser(
                                                                    url);
                                                              });
                                                            },
                                                            child: CircleAvatar(
                                                              ...
                                                              child: CircleAvatar(
                                                                  ...
                                                                  child: (searchResult[position].pictureName != null)
                                                                      ? CircleAvatar(
                                                                          ...
                                                                          child: CircleAvatar(
                                                                              ...
                                                                              backgroundImage: AssetImage(
                                                                                searchResult[position].pictureName,
                                                                              )))
                                                                      : Image.asset(
                                                      ...
                                                      Container(
                                                          ...
                                                          child: Center(
                                                            ...
                                                            children: [
                                                              Container(
                                                                margin: EdgeInsets.only(
                                                                    top: searchResult[position].user_id ==
                                                                            1
                                                                        ? 13
                                                                        : 10),
                                                                child:
                                                                ...
                                                                child: searchResult[position]
                                                                    ...
                                                                    : FlutterSwitch(
                                                                        ...
                                                                        onToggle:
                                                                            (val) async {
                                                                          var v =
                                                                              searchResult[position].is_challengVerified;
                                                                          var f =
                                                                              val.toString();
                                                                          bool status = await db.challengVerified(
                                                                              searchResult[position].user_id,
                                                                              val.toString());
                                                                          setState(
                                                                              () {
                                                      ...
                                                      Container(
                                                          ...
                                                          child:
                                                            ...
                                                            onTap: () {
                                                              setState(() {
                                                                var url =
                                                                    'https://www.instagram.com/${k[position].hero_instagram}/';
                                                                launchInBrowser(
                                                                    url);
                                                              });
                                                            },
                                                            child: CircleAvatar(
                                                              ...
                                                              child: CircleAvatar(
                                                                  backgroundColor: Colors.white,
                                                                  radius: size.width * .072,
                                                                  child: (k[position].pictureName != null)
                                                                      ? CircleAvatar(
                                                                          backgroundColor: Colors.black,
                                                                          radius: size.width * .072,
                                                                          child: CircleAvatar(
                                                                ...
                                                                child: k[position]
                                                                    ...
                                                                    : FlutterSwitch(
                                                                        ...
                                                                        onToggle:
                                                                            (val) async {
                                                                          var v =
                                                                              k[position].is_challengVerified;
                                                                          var f =
                                                                              val.toString();
                                                                          bool status = await db.challengVerified(
                                                                              k[position].user_id,
